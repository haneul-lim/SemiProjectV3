  ...
  <div class="card card-body bg-light col-10 offset-1">
      <form name="boardfrm" id="boardfrm">
                ...
                <div class="form-group row">
                    ...
                    <input type="text" id="userid" name="userid" class="border-danger form-control col-9"
                           value="${UID}" readonly>
                </div>
                <div class="form-group row">
        ...
        <div class="col-12 text-center">
            <button type="button" class="btn btn-primary btn-sm" id="savebdbtn"><i class="fas fa-check"></i> 입력완료</button>
            <button type="reset" id="cnclbtn" class="btn btn-danger btn-sm"><i class="fas fa-times"></i> 다시입력</button>
        </div><!-- 버튼들 -->
