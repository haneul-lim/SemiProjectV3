...
<%--
    데이터가 너무 많아 한 페이지에 모든 것을 출력하기 어려운 경운
...
<div id="main">
<div>
    <i class="bi bi-people-fill" style="font-size: 2rem">자유 게시판 ${tp} / ${bdcnt}</i>
<hr>
</div> <!--페이지 타이틀-->
    ...
    <div class="col-12">
        <ul class="pagination justify-content-center">
            ...
            <c:forEach var="i" begin="${sp}" end="${ep}" step="1">
                <%--표시하는 페이지 i가 총페이지수보다 작거나 같을 동안만 출력 --%>
                <c:if test="${i le tp}">
                    <c:if test="${cp eq i}">
