<%@ page pageEncoding="UTF-8"%>
 ...
 <div id="main">
 	<script src="https://www.google.com/recaptcha/api.js"></script>
             <div>
                <i class="bi bi-people-fill" style="font-size: 2rem">
                    회원가입</i>
            <hr>
            </div> <!-- 페이지 타이틀 -->
            ...
            <div class="card card-body bg-light">
                ...
                <form id="joinfrm" name="joinfrm">
                        ...
                        <div class="col-11 offset-1">
                            <div class="form-group row">
                                <label class="col-2 col-form-label text-danger text-right"
                                       for="name">이름</label>
                                <input type="text" name="name" id="name" class="border-danger form-control col-2" readonly>
                            </div> <!-- 이름 -->
                            <div class="form-group row">
                                <label class="col-2 col-form-label text-danger text-right" for="jumin1">
                                주민번호</label>
                                <input type="text" name="jumin1" id="jumin1" class="border-danger form-control col-2" readonly>
                                <span class="col-form-label">&nbsp; &mdash; &nbsp;</span>
                                <input type="password" name="jumin2" id="jumin2" class="border-danger form-control col-2" readonly>
                            </div> <!-- 주민번호 -->
                            <div class="form-group row">
                            ...
                            <div class="form-group row">
                                ...
                                <input type="password" name="repasswd" id="repasswd" class="border-danger form-control col-3">
                            ...
                            <div class="form-group row">
                                ...
                                <input type="text" name="zip1" id="zip1" class="border-danger form-control col-4">
                                &nbsp;&nbsp;
                            ...
                            <div class="form-group row">
                                ...
                                <input type="text" name="email1" id="email1" class="border-danger form-control col-3">
                            ...
                            <div class="form-group row">
                                ...
                                <span class="col-form-label">&nbsp; &mdash; &nbsp;</span>
                                <input type="text" name="tel1" id="tel1" class="border-danger form-control col-2">
                                <span class="col-form-label">&nbsp; &mdash; &nbsp;</span>
                                <input type="text" name="tel2" id="tel2" class="border-danger form-control col-2">
                            </div> <!-- 전화번호-->
                    ...
                    <div class="row">
                        ...
                        <hr>
                        <button type="button" class="btn btn-primary" id="joinbtn"><i class="bi bi-check-circle"></i>
                            입력완료</button>
                        <button type="button" class="btn btn-danger" id="cancelbtn"><i class="bi bi-x-circle"></i>
                            입력취소</button>
                        </div>
                    </div>  <!-- 버튼들-->
                </form>
                ...
                <div class="modal-dialog modal-lg">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form name="zipfrm" id="zipfrm">
                                <div class="form-inline row justify-content-center">
                                    ...
                                    &nbsp;&nbsp;
                                    <input type="text" name="dong" id="dong" class="border-primary form-control col-4">
                                    &nbsp;&nbsp;
                                    <button type="button" class="btn btn-primary" id="findzipbtn"><i class="bi bi-search"></i> 검색하기</button>
                                </div>
                                <div class="form-group row">
                                    <hr class="col-9">
                        ...
                        <div class="modal-footer">
                            <button type="button" class="btn btn-danger"><i class="bi bi-check-square"></i> 선택하고 닫기</button>
                        </div>
                    </div>
                </div>
            </div>
