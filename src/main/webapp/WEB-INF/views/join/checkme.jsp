<%@ page pageEncoding="UTF-8"%>
        ...
        <div id="main">
            ...
            <div>
                ...
                회원으로 가입하는 방법에는 2가지가 있습니다. <br>
                입력하신 정보는 본 사이트에 가입 전까지 저장되지 않습니다.
                </small>
                <hr>
            </div> <!--섹션 타이틀-->
                ...
                <form id="checkfrm1" name="checkfrm1">
                    <div class="row">
                        <div class="col-5 offset-1">
                            <div class="form-group row">
                                <label class="col-4 col-form-label text-warning text-right"
                                       for="name">이름</label>
                            ...
                            <div class="form-group row">
                                ...
                                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                <div class="custom-control custom-radio">
                                    <input type="radio" id="fmale" name="gender" value="f"
                                    class="custom-control-input">
                        ...
                        <div class="col-5">
                            <ul style="color: dodgerblue; font-weight: bold">
                                <li>주민번호 입력 없이 전화번호로 회원가입이 가능합니다.</li>
                    ...
                    <div class="row">
                        <div class="col text-center">
                            <hr style="width: 90%">
                            <button type="button" id="chk1btn" class="btn btn-primary"><i class="bi bi-check"></i>확인하기</button>
                            <button type="button" id="cancel1btn" class="btn btn-danger"><i class="bi bi-x"></i>취소하기</button>
                        </div>
                    </div> <!--버튼들-->
                </form>
            </div> <!--회원가입-->
                ...
                <form id="checkfrm2" name="checkfrm2">
                    ...
                    <div class="row">
                        <div class="col-5 offset-1"
                            ...
                            <div class="form-group row">
                                <label class="col-4 col-form-label text-warning text-right" for="jumin1">
                                주민번호</label>
                                <input type="text" name="jumin1" id="jumin1" class="border-warning form-control col-3">
                                <span class="col-form-label">&nbsp; &mdash; &nbsp;</span>
                                <input type="password" name="jumin2" id="jumin2" class="border-warning form-control col-3">
                            </div>
                    ...
                    <div class="row">
                        <div class="col text-center">
                            <hr style="width: 90%">
                            <button type="button" id="chk2btn" class="btn btn-primary"><i class="bi bi-check"></i>확인하기</button>
                            <button type="button" id="cancel2btn" class="btn btn-danger"><i class="bi bi-x"></i>취소하기</button>
                        </div>
                    </div> <!--버튼들-->
                </form>
            </div> <!--실명 회원가입-->
